...
This script decodes the MAZEDATA.EGA file which contains the dungeon
wall, floor, and ceiling textures for Wizardry 6.
"""
...
def extract_wall_textures(input_path: Path, output_dir: Path):
    ...
    # Optimized plane order found via statistical analysis of gray pixel density
    order = [0, 2, 3, 1]
...
if __name__ == "__main__":
    ...
    output_path = Path("output/mazedata_extracted_v5")
